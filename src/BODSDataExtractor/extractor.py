...
# =============================================================================
            ...
            service_object, stop_object, vehicle_journey, journey_pattern_section_object = create_dataclasses(xml_text,self)
            journey_pattern_section_index, journey_pattern_index, journey_pattern_list, stop_point_index = map_indicies(self)
...
def create_dataclasses(xml_text,self):
...
def organise_timetables():
    ...
    collated_timetable_outbound, collated_timetable_inbound = generate_timetable_stop(self)
